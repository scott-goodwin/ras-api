...
class FileProcessingServiceSpec
  ...
  val STATUS_FILE_PROCESSING_INTERNAL_SERVER_ERROR: String =
  ...
  val SUT = new FileProcessingService {
    ...
    override val FILE_PROCESSING_MATCHING_FAILED: String =
      STATUS_FILE_PROCESSING_MATCHING_FAILED
    override val FILE_PROCESSING_INTERNAL_SERVER_ERROR: String =
      STATUS_FILE_PROCESSING_INTERNAL_SERVER_ERROR
...
//        val result = await(SUT.fetchResult(inputRow, userId, fileId, V2_0))
